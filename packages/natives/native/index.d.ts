...
export declare class AudioCapture {
  ...
  constructor(sampleRate: number, onAudio: (error: Error | null, samples: Float32Array) => void, inputDeviceId?: string | undefined | null)
...
export declare class LiveWebRtcPeer {
   ...
   * callbacks.
   */
  constructor(onEvent: (error: Error | null, payload: string) => void, onInputLevel: (error: Error | null, level: number) => void, onOutputLevel: (error: Error | null, level: number) => void, onFailure: (error: Error | null, message: string) => void, audioProcessing: LiveAudioProcessingConfig, inputDeviceId?: string | undefined | null, outputDeviceId?: string | undefined | null)
  /**
  ...
  refreshMicrophone(inputDeviceId?: string | undefined | null): void
  /** Read this call's monotonic media counters and negotiated codec summary. */
  getDiagnostics(): LiveAudioDiagnostics
  /**
...
export declare enum LiveAgcMode {
  Off = 'off',
...
export declare function liveAudioProcessingAvailable(): boolean

/** Typed audio-processing settings resolved by the TypeScript host. */
export interface LiveAudioProcessingConfig {
  echoCancellation: LiveEchoCancellationMode
  /** Render-to-capture delay in milliseconds; zero requests estimation. */
  echoDelayMs: number
  noiseSuppression: LiveNoiseSuppressionLevel
  agc: LiveAgcMode
 ...
 */
export declare enum LiveEchoCancellationMode {
  Off = 'off',
...
export declare enum LiveNoiseSuppressionLevel {
  Off = 'off',
  Low = 'low',
  Moderate = 'moderate',
  High = 'high',
